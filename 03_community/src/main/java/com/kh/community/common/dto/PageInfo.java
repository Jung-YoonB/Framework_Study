 ...
 * 
 * - 게시판 목록처럼 데이터가 많아질 경우 한 번에 전부 가져 올 필요없이
 *   필요한만큼만 끊어서 보여주고자 할 경우 사용하는 방법 (페이징 처리)
 *   
...
public class PageInfo {
	...
	private int size;				// 한 페이지에 보여 줄 게시들 개수
	private int totalCount;			// 전체 목록 개수 (게시글 개수)
	
	private int totalPages;			// 전체 페이지 수
	private int startPage;			// 화면에서 보여 줄 페이지 시작 번호
